...
[task_local]
20 0 * * * https://raw.githubusercontent.com/LeonardoNorskog/TOMM_BOXJS/main/XiaoLanTools/xl_tools_ad.js, tag=小懒工具箱签到

[rewrite_local]
获取token
^https:\/\/wxapp\.xiaolankj\.top\/api\/app\/user\.php\?act\=userCheckIn url script-request-header https://raw.githubusercontent.com/LeonardoNorskog/TOMM_BOXJS/main/XiaoLanTools/xl_tools_ad.js
...
function checkin() {
  const xiaolanTools = {
    url: 'https://wxapp.xiaolankj.top/api/app/user.php?act=receiveVideoReward',
    headers: {
      token: token,
  ...
  $.post(xiaolanTools, async function (error, response, data) {
